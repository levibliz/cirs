  ...
  return (
    <section className="w-full py-24" style={{ background: 'var(--bg)' }}>
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
        ...
        >
          <h1 className="text-4xl md:text-6xl font-extrabold leading-tight" style={{ color: 'var(--fg)' }}>
          ...
          <p className="mt-6 text-lg max-w-md" style={{ color: 'var(--muted)' }}>
            CIRS helps citizens report and track civic issues like potholes,
            broken lights, and garbage problems. Join thousands making their
            communities stronger every day.
          </p>
          ...
          {/* Rating */}
          <div className="flex items-center gap-2 mt-6 text-sm" style={{ color: 'var(--muted)' }}>
